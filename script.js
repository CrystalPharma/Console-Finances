...
//     }
// }
// document.write("<br>Greatest Increase in Profits: " + max);
// string and integer Good practise to store in the same data type ***


var netMax = -Infinity; var maxDate = "";
for (let i = 0; i < finances.length; i++) {
    if (netMax < finances[i][1]) {
        netMax = finances[i][1];
...
//     }
// }
// document.write("<br>Greatest Decrease in Profits: " + min);

var netMin = Infinity; var minDate = "";
for (let i = 0; i < finances.length; i++) {
    if (netMin > finances[i][1]) {
        netMin = finances[i][1];
